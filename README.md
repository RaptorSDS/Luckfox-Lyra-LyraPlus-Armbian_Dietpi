...
sudo nano ~/build/cache/sources/linux-kernel-worktree/6.1__rockchip__armhf/arch/arm/boot/dts/rk3506-luckfox-lyra.dtsi
...
or
./compile.sh build   BOARD=luckfox-lyra-plus   BRANCH=vendor   RELEASE=trixie   BUILD_DESKTOP=no   BUILD_MINIMAL=yes   KERNEL_CONFIGURE=no  WIRELESS_EXTERNAL=no INSTALL_ARMBIAN_FIRMWARE=yes   INSTALL_FIRMWARE_ALL=yes   WIRELESS_UTILS="iw wireless-tools wpasupplicant"   NETWORKING_UTILS="network-manager nmtui"
